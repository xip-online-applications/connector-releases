...
var NestedSetMultipleRootError_exports = {};
__export(NestedSetMultipleRootError_exports, {
  NestedSetMultipleRootError: () => NestedSetMultipleRootError
});
module.exports = __toCommonJS(NestedSetMultipleRootError_exports);
var import_TypeORMError = require("./TypeORMError");
class NestedSetMultipleRootError extends import_TypeORMError.TypeORMError {
  constructor() {
