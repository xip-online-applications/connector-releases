...
var LimitOnUpdateNotSupportedError_exports = {};
__export(LimitOnUpdateNotSupportedError_exports, {
  LimitOnUpdateNotSupportedError: () => LimitOnUpdateNotSupportedError
});
module.exports = __toCommonJS(LimitOnUpdateNotSupportedError_exports);
var import_TypeORMError = require("./TypeORMError");
class LimitOnUpdateNotSupportedError extends import_TypeORMError.TypeORMError {
  constructor() {
