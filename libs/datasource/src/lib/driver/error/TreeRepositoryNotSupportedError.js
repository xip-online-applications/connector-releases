...
var TreeRepositoryNotSupportedError_exports = {};
__export(TreeRepositoryNotSupportedError_exports, {
  TreeRepositoryNotSupportedError: () => TreeRepositoryNotSupportedError
});
module.exports = __toCommonJS(TreeRepositoryNotSupportedError_exports);
var import_TypeORMError = require("./TypeORMError");
class TreeRepositoryNotSupportedError extends import_TypeORMError.TypeORMError {
  constructor(driver) {
    super(
