...
var kafka_base_service_exports = {};
__export(kafka_base_service_exports, {
...
class KafkaBaseService extends import_abstract_kafka_service.AbstractKafkaService {
  ...
  setCallbackFunction(callbackFunction, eventType = KafkaBaseService.DEFAULT_CALLBACK_EVENT_TYPE, identifier = "") {
    ...
    this.callbackWrappers.get(eventType).push({
      callback,
      identifier: eventType === KafkaBaseService.DEFAULT_CALLBACK_EVENT_TYPE ? this.baseYamlConfig.processIdentifier : identifier
    });
  }
}
